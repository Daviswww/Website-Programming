...
<html>
  ...
  <body>
    ...
    <div class="inside">
      ...
      <div class="ininder">
      <h1>DELETE</h1><br>
      <form action = "../script/del.php" method="GET">
        	<div>
        		NAME:
            <input type="text" name="a"><br>
        	</div>
        	<button class="button" type="submit" name = "submit" ><span>Delete</span></button>
      </form>	
      
      <?php
        $show = new Show();
        echo "<h1>IS DELDET</h1><br>";
        if(isset($_SESSION["name"])){
          echo $_SESSION["name"] . "is delete.";
        }
