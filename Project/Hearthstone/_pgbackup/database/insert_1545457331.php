...
<html lang="en"> 
    ...
    ================================================== -->         
        ...
        <div class="form-group float-left"> 
            ...
            <input type="text" class="form-control" id="formInput410" placeholder="Point"> 
        </div>
        <div class="form-group float-left"> 
            <label for="formInput434">攻擊</label>             
            <input type="text" class="form-control" id="formInput434" placeholder="Enter name"> 
        </div>
        <div class="form-group float-left"> 
            <label for="formInput442">防禦</label>             
            <input type="text" class="form-control" id="formInput442" placeholder="Enter name"> 
        </div>
        <div class="form-group"> 
