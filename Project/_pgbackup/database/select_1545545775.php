                    ...
                    <form action="select.php" method="POST"> 
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups"> 
                            <div class="btn-group" role="group" aria-label="First group"> 
                                <button type="button" name="op" class="btn btn-danger">ALL</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Neutral</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Hunter</button>
                                <button type="button" name="op" class="btn btn-secondary">Mage</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Paladin</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Priest</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Thief</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Shaman</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Warlock</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Warrior</button>                                 
                                <button type="button" name="op" class="btn btn-secondary">Warlock</button>                                 
                            </div>                             
                        </div>
