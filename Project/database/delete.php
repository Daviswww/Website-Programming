            ...
            <div class="starter-template"> 
                ...
                <div class="form-group float-left"> 
                    <form action="../includes/delete.inc.php" method="POST">
                        ...
                        <input type="text" class="form-control" name = "name" id="formInput91" placeholder="Enter card name"> 
                        <button type="submit" name="submit" class="btn btn-danger float-left">Delete</button>                         
                    </form>
                </div>                 
                <?php
