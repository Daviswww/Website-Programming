            ...
            <div class="starter-template"> 
                ...
                <form action="../includes/update.inc.php" method="POST">
                    <div class="form-group"> 
                        <label for="formInput392" class="float-left lead font-weight-bold">#想更新的卡片名稱</label>                         
                    ...
                    <button class="btn btn-outline-success my-2 my-sm-0" name="submit" type="submit">Update</button>
                </form>
            </div>
        </div>         
        <!-- /.container -->         
